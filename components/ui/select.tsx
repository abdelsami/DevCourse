...
const SelectContent: React.FC<SelectContentProps> = ({ children }) => {
    ...
    return (
        <div
            ref={contentRef}
            className="absolute top-full left-0 right-0 z-50 mt-1 max-h-96 overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95"
        >
