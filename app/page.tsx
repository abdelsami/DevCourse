...
export default async function HomePage() {
  // Get all courses from the database using pg
  const courses = await query(`SELECT * FROM "Course" ORDER BY "createdAt" DESC`);
  console.log(courses);
  // Mock data for fields not in the database
  // const getCourseData = (courseId: string) => ({
  //   courseId : 0,
  const getCourseData = (courseId: string) => ({
    courseId : 0,
    enrollmentCount: Math.floor(Math.random() * 2000) + 500 +courseId ,
    averageRating: 4.7,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-yellow-200">Learn. Build. Succeed.</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 text-white">
                  ...
                  <span className="text-sm font-medium">New courses every week</span>
                </div>
                ...
                <p className="text-xl text-gray-300 leading-relaxed max-w-lg">
                  Learn from industry experts and build real-world projects that advance your career. Join thousands of developers who trust our platform.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="space-y-4 max-h-96 overflow-hidden">
                <div className="animate-scroll space-y-4">
                  {[
                    { title: "React Masterclass", tech: "React", color: "from-yellow-500 to-orange-500", icon: <Code className="h-5 w-5" /> },
                    { title: "Node.js Backend", tech: "Node.js", color: "from-green-500 to-emerald-500", icon: <Database className="h-5 w-5" /> },
                    { title: "Full-Stack App", tech: "MERN", color: "from-orange-500 to-red-500", icon: <Laptop className="h-5 w-5" /> },
                    { title: "Mobile Development", tech: "React Native", color: "from-blue-500 to-purple-500", icon: <Smartphone className="h-5 w-5" /> },
                    { title: "DevOps Essentials", tech: "Docker", color: "from-purple-500 to-pink-500", icon: <Globe className="h-5 w-5" /> },
                    { title: "TypeScript Pro", tech: "TypeScript", color: "from-indigo-500 to-blue-500", icon: <Code className="h-5 w-5" /> },
                  ].map((course, index) => (
                    <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                      <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 bg-gradient-to-r ${course.color} rounded-lg flex items-center justify-center text-white`}>
                          {course.icon}
                        </div>
      ...
      <div id="courses" className="relative bg-white py-20">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="text-center mb-16 space-y-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover our most popular and highly-rated courses, carefully crafted by industry experts to accelerate your development journey
            </p>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-12">
            {["All Courses"].map((category) => (
              <Button
                ...
                className={`rounded-full ${category === "All Courses" ? "bg-yellow-400 hover:bg-yellow-500 text-black" : "hover:bg-yellow-50 border-gray-300"}`}
              >
                {category}
              </Button>
            ))}
          ...
          {courses.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h3 className="text-2xl font-semibold mb-3">No courses available yet</h3>
              <p className="text-gray-600 text-lg mb-6">We`re working hard to bring you amazing courses. Check back soon!</p>
              <Button className="bg-yellow-400 hover:bg-yellow-500 text-black">Get Notified When Available</Button>
            </div>
          ) : (
            <>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                {courses.map((
                  ...
                  return (
                    <Card
                      key={course.id}
                      className="group transition-all duration-500 border-0 shadow-lg bg-white overflow-hidden"
                    >
                        ...
                        <div className="relative aspect-video">
                          ...
                          <div className="absolute top-4 right-4">
                            <Badge className="bg-red-500 hover:bg-red-600 text-white border-0 animate-pulse">
                              {(course.originalPrice - course.price) / course.originalPrice * 100 | 0}% OFF
                            </Badge>
                          </div>
                      ...
                      <CardContent className="px-6 pb-6 space-y-4">
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-500">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span>{courseData.enrollmentCount.toLocaleString()}</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="flex items-center">
                            {[...Array(5)].map((_, i) => (
                              <Star
                                key={i}
                                className={`h-4 w-4 ${i < Math.floor(courseData.averageRating) ? "fill-yellow-400 text-yellow-400" : "text-gray-300"}`}
                              />
                            ))}
                          </div>
                          <span className="font-medium">{courseData.averageRating}</span>
                          <span className="text-gray-500">({courseData.reviewCount} reviews)</span>
                        </div>
              ...
              <div className="text-center space-y-4">
                <p className="text-gray-600">Showing {courses.length} of {courses.length} courses</p>
              </div>
            </>
          )}
          <div className="mt-20 pt-16 border-t">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">Find the perfect course for your learning goals</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { name: "Web Development", count: "25+ courses", icon: <Code className="h-8 w-8" />, color: "from-yellow-500 to-orange-500", description: "Frontend, Backend, Full-stack" },
                { name: "Mobile Development", count: "18+ courses", icon: <Smartphone className="h-8 w-8" />, color: "from-orange-500 to-red-500", description: "iOS, Android, React Native" },
                { name: "DevOps & Cloud", count: "15+ courses", icon: <Database className="h-8 w-8" />, color: "from-green-500 to-emerald-500", description: "AWS, Docker, Kubernetes" },
                { name: "Data Science", count: "12+ courses", icon: <Globe className="h-8 w-8" />, color: "from-blue-500 to-purple-500", description: "Python, ML, Analytics" },
                { name: "UI/UX Design", count: "10+ courses", icon: <Laptop className="h-8 w-8" />, color: "from-purple-500 to-pink-500", description: "Figma, Design Systems" },
                { name: "Cybersecurity", count: "8+ courses", icon: <BookOpen className="h-8 w-8" />, color: "from-red-500 to-pink-500", description: "Ethical Hacking, Security" },
              ].map((category, index) => (
                <Card key={index} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer border-0 bg-gradient-to-br from-white to-gray-50">
                  <CardContent className="p-6 text-center space-y-4">
                    <div className={`w-16 h-16 mx-auto bg-gradient-to-r ${category.color} rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300`}>
                      {category.icon}
                    </div>
                    <div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Join thousands of developers who have advanced their careers with our comprehensive courses. Start building real projects today!
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 py-8">
              <div className="flex flex-col items-center gap-3 p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                <p className="text-sm text-gray-300 text-center">Learn at your own pace with unlimited access to all course materials</p>
              </div>
              <div className="flex flex-col items-center gap-3 p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                <p className="text-sm text-gray-300 text-center">Learn from industry professionals with years of real-world experience</p>
              </div>
              <div className="flex flex-col items-center gap-3 p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                <div className="w-12 h-12 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-lg flex items-center justify-center">
                ...
                <p className="text-sm text-gray-300 text-center">Highly rated by students worldwide for quality and effectiveness</p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Empowering developers worldwide with high-quality courses and hands-on projects. Start your coding journey with us today.
              </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li><p className="hover:text-white transition-colors">Web Development</p></li>
                <li><p className="hover:text-white transition-colors">Mobile Development</p></li>
                <li><p className="hover:text-white transition-colors">Backend Development</p></li>
                <li><p className="hover:text-white transition-colors">DevOps & Cloud</p></li>
                <li><p className="hover:text-white transition-colors">Data Science</p></li>
                <li><p className="hover:text-white transition-colors">Machine Learning</p></li>
              </ul>
            </div>
            <div className="space-y-4">
          ...
          <div id="contact" className="border-t border-gray-800 mt-12 pt-8">
            <div className="max-w-md mx-auto text-center space-y-4">
              ...
              <p className="text-sm text-gray-300">Get the latest courses and updates delivered to your inbox</p>
